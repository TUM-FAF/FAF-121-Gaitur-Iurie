                     ...
                     int nCmdShow)
{
    ...
    wincl.hbrBackground = CreatePatternBrush(LoadBitmap(hInst,MAKEINTRESOURCE(IDB_BACKGROUND_1)));
    ...
    switch (message)                  /* handle the messages */
    {
        ...
        case WM_CLOSE:
        {
            ...
            case WM_PAINT:
            {
                ...
                HBITMAP backgrBMP = LoadBitmap(hInst, MAKEINTRESOURCE(IDB_BACKGROUND_1));
                ...
                SetTextColor(hdc, RGB(152, 0, 16));
                DrawText(hdc,"Done with pride by Iura Gaitur",-1,&rect,DT_CENTER|DT_BOTTOM|DT_SINGLELINE);
